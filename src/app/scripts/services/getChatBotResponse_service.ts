...
@Injectable()
class getChatBotResponse_service {
    ...
    execute(reqOpts ? : any) {
         ...
         */
        let config = {
            url: "https://api.appery.io/rest/1/code/2984c180-53a3-483c-9753-4162ad3bc1b6/exec",
            method: "post",
            headers: this.entityAPI.get("getChatBotResponse_service.request.headers"),
            params: this.entityAPI.get("getChatBotResponse_service.request.query"),
            data: this.entityAPI.get("getChatBotResponse_service.request.body", reqOpts.data, true, true) || "",
            aio_config: {
                requestType: "json",
                responseType: "json",
                serviceName: "getChatBotResponse_service"
            }
        };
...
*/
export {
    getChatBotResponse_service as ExportedClass
};